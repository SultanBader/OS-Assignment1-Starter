...
public class SchedulerSimulation {
    ...
    // 2 Feature: Counter to track number of context switches
    static int contextSwitches = 0;

    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 444050009; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            int priority = 1 + random.nextInt(5); // Feature 1 : priority bettwen 1 to 5
        ...
        while (!processQueue.isEmpty()) {
            ...
            // 2 Feature: Increment context switch count whenever a new process starts
            contextSwitches++;
            currentThread.start();
    ...
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue,
        ...
        System.out.println(Colors.BLUE + "  ➕ " + Colors.BOLD + Colors.CYAN + process.getName() +
                ...
                " added to ready queue (Priority: " + process.getPriority() + ")" +
                Colors.RESET +
